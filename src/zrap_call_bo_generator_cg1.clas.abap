CLASS zrap_call_bo_generator_cg1 DEFINITION
PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zrap_call_bo_generator_cg1 IMPLEMENTATION.
...
*          iv_package            =  'ZRAP_FLIGHT_M_CG1'
*          iv_namespace = 'ZRAP_'
*          iv_header_table       = 'ZRAP_TRAVEL_CG1'
...
*        ).
        ...
        DATA(rap_bo_generator) = NEW zrap_cl_bo_generator(
          iv_package            =  'ZRAP_INVENTORY_M_CG1'
          iv_namespace = 'ZRAP_'
          iv_header_table       = 'ZRAP_INVEN_CG1'
